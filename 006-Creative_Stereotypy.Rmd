...
ggsave(filename = 'Figures/creative_count_plot.png' ,width = 4.78, height = 7.5, dpi = 600, units = "in", device='png')
...
ggsave(filename = 'Figures/stereotypy_count_plot.png' ,width = 4.78, height = 7.5, dpi = 600, units = "in", device='png')
