...
creative_csonly_corrected <- creative_all %>% 
  select(c(participant, condition, creative_count_corrected, creative_proportion_c)) %>% 
  distinct()
...
stereotypy_ssonly_corrected <- stereotypy_all %>% 
  select(c(participant, condition, stereotypy_count_corrected, stereotypy_proportion_c)) %>% 
  distinct()
...
creative_csonly_corrected %>%
  emmeans_test(creative_count_corrected ~ condition, p.adjust.method = "tukey")
